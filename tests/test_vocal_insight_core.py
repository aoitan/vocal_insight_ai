...
"""
import pytest
from vocal_insight.core.types import FeatureData, SegmentAnalysis, AnalysisConfig
...
class TestCoreConfig:
    ...
    def test_validate_config_with_invalid_percentile(self):
        ...
        # When & Then: 検証が失敗する
        with pytest.raises(ValueError, match="rms_delta_percentile must be between 0 and 100"):
    ...
    def test_validate_config_with_invalid_segment_length(self):
        ...
        # When & Then: 検証が失敗する
        with pytest.raises(ValueError, match="min_len_sec must be less than max_len_sec"):
            validate_config(invalid_config)